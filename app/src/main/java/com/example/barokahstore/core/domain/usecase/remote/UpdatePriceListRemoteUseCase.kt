...
class UpdatePriceListRemoteUseCase @Inject constructor(
    ...
    suspend fun invoke(nama: String, harga: Int, keterangan: String, id: Int): ResultApi<ResponseModel.Result, ErrorResponse> {
        return  remoteDataRepository.updatePriceList(nama, harga, keterangan, id)
    }
}